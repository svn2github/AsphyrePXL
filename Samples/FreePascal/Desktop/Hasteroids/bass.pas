...
// Yuriy Kotsarenko, September 2015: The following needs to be added in FreePascal on OSX to link properly.
...
{$IFDEF LINUX}
  bassdll = 'libbass.so';
{$ENDIF}
// Yuriy Kotsarenko, September 2015: FreePascal wouldn't recognize "MACOS", it should be "DARWIN".
