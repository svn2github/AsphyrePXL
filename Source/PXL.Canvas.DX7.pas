...
procedure TDX7Canvas.PutPixel(const Point: TPoint2f; const Color: TIntColor);
var
...
procedure TDX7Canvas.Line(const Point1, Point2f: TPoint2f; const Color: TColorPair);
var
  VertexEntry: PVertexRecord;
begin
...
procedure TDX7Canvas.DrawIndexedTriangles(const Vertices: PPoint2f; const Colors: PIntColor; const Indices: PLongInt;
...
procedure TDX7Canvas.DrawTexturedTriangles(const Texture: TCustomBaseTexture; const Vertices, TexCoords: PPoint2f;
  const Colors: PIntColor; const Indices: PLongInt; const VertexCount, TriangleCount: Integer;
