...
procedure TGLESCanvas.InsertVertex(const Position, TexCoord: TPoint2; const Color: TIntColor);
begin
...
procedure TGLESCanvas.DrawTexturedTriangles(const Texture: TCustomBaseTexture; const Vertices, TexCoords: PPoint2;
  const Colors: PIntColor; const Indices: PLongInt; const VertexCount, TriangleCount: Integer;
